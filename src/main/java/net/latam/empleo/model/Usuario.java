 ...
 */
package net.latam.empleo.model;
...
public class Usuario {
	...
	@ManyToMany(fetch=FetchType.EAGER)//sierve para especificar una busqueda de usuario, se rescaten en la misma consulta todos los perfiles que esten asociados a el
